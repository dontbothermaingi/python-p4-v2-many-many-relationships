"""Add employee_meetings association table to models.py

Revision ID: c1587288610c
Revises: b5164e5ddc7b
Create Date: 2024-04-03 16:49:26.735913
...
revision = 'c1587288610c'
down_revision = 'b5164e5ddc7b'
branch_labels = None
depends_on = None
